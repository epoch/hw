...
var getRandom = function(items) { // helper function to not repeat self
  return items[Math.floor(Math.random()*items.length)];
}
console.log("It's like " + getRandom(_this) + " for " + getRandom(_that));
// var randomThis = function(){
//   var rThis = getRandom(_this);
//   console.log(rThis);
// }

// var randomThat = function(){
//   var rThat = getRandom(_that);
//   console.log(rThat);
// }
